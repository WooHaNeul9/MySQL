...
-- qatar_asian_cup
-- country (name[가변 문자열 30], group_name[가변 문자열 1], manager[가변문자열 30], lanking[정수])
-- stadiom(name[가변 문자열 50], capacity[정수], address[가변 문자열 255])
-- player(name[가변 문자열 30], age[정수], position[가변문자열 15], pro_team[가변문자열 30], uniform_number[정수], country[가변문자열 30])
